...
namespace FialBP.Controllers
{
    public class SchedulesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ScheduleId,DepartureTime,ArrivalTime,BusId,RouteId")] Schedule schedule)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ScheduleId,DepartureTime,ArrivalTime,BusId,RouteId")] Schedule schedule)
        {
            if (ModelState.IsValid)
            {
